 ...
 <p class="text-warning text-center"></p>	
    ...
    <div class="top-bar">
        ...
        <div class="row">
            <div class="col-md-12">
                <ul class="pull-left">
                    <li><i class="fa fa-phone"> </i> &nbsp; 1800 111 1311</li>
                    <li><i class="fa fa-envelope"> </i> &nbsp; carahdesk.wcd@nic.in</li>
                </ul>
                <ul class="pull-right">
  ...
  <div class="container">
    <div class="navbar-header">
	  ...
	  <img style="height:100px; background:#fff; paddign:5px; float:left;" src="./img/logo1.jpeg" class="img img-responsive">
